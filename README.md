...
**Live site:** https://nraford7.github.io/artificial-republic/

## Build notes

- Single self-contained `index.html`, no build step.
- Type: Libre Caslon Display + Spectral.
- Imagery generated with Recraft V4 Pro, art direction "The Water Reads Back" (Venice at first light, fog on the water). See `art-direction/`.
- Register: long-form editorial, dark atmospheric palette (ink-teal, mist, gold).
